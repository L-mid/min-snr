# E8 – Min-SNR γ sweep (mini, 5k, bc32)
...
**Configs:**
- E8a (γ=1): `configs/study/MS1_min_snr/e8/e8a_minsnr_linear_gamma1_5k_bc32.yaml`
- E8b (γ=3): `configs/study/MS1_min_snr/e8/e8b_minsnr_linear_gamma3_5k_bc32.yaml`
- E8c (γ=5): `configs/study/MS1_min_snr/e8/e8c_minsnr_linear_gamma5_5k_bc32.yaml`
...
- **Model:** `unet_cifar32`, `base_channels=32`, defaults otherwise.
...
- Smaller logging interval used to accomidate for larger base channel size.