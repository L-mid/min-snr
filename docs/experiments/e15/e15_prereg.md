...
Seed-to-seed spread very small and stable, and low nfe brings down eval time for extremely similar metric results. This run is to measure the spread, not to win. Can also be compared to baseline (nfe = 50).
