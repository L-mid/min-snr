"""
Usage:
    python tools/e10/plot_e10_scalar_vs_step.py \
    docs/assets/e10/e10a_data/loss.jsonl \
    docs/assets/e10/e10b_data/loss.jsonl \
    --names e10a-ddpm e10b-ddim \
    --key val/recon_mse_fixed_mean \
    --out docs/assets/e10/e10_plots/e10_recon_mse_fixed_mean_vs_step_ab.png

    # psnr:
    python tools/e10/plot_e10_scalar_vs_step.py \
    docs/assets/e10/e10a_data/loss.jsonl docs/assets/e10/e10b_data/loss.jsonl \
    --names e10a-ddpm e10b-ddim \
    --key val/recon_psnr_fixed_mean \
    --out docs/assets/e10/e10_plots/e10_recon_psnr_fixed_mean_vs_step_ab.png
...
def main():
    ...
    for path, name in zip(args.loss_jsonls, args.names):
        ...
        x, y = extract_xy(recs, args.key)
        plt.plot(x, y, marker="o", label=name)

    plt.xlabel("step")
    plt.ylabel(args.key)
    plt.title(f"E10: {args.key} vs step")
    plt.legend()
